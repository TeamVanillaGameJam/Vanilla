...
{
	/*if (!TheTextureManager::Instance()->load("Images/gameover.png", "gameovertext", TheGame::Instance()->getRenderer()))
	{
		return false;
	}*/
	...
	if (!TheTextureManager::Instance()->load("Images/newgame.png", "restartbutton", TheGame::Instance()->getRenderer()))
	{
		return false;
	}
